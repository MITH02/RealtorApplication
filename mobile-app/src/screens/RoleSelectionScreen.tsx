...
import { Container, Title, BodyText, RoleCard, RoleTitle, RoleDescription } from '../components/StyledComponents';
  ...
  const roles = [
    {
      id: 'super_admin',
      title: 'Super Admin',
      description: 'Configure admin accounts and manage system settings. Limited access to daily operations.',
    ...
    },
    {
      id: 'admin',
      title: 'Admin',
      description: 'Manage buildings, assign contractors, create tasks, and approve work completions.',
      color: colors.admin,
      icon: '🏗️',
    ...
    },
    {
      id: 'contractor',
      title: 'Contractor',
      description: 'View assigned tasks, update progress, and submit work for approval.',
        ...
        <Content>
          <Header>
            ...
            <BodyText style={{ color: colors.textSecondary }}>
              Select your role to access the appropriate features and tools for your construction management needs.
            </BodyText>
          </Header>
