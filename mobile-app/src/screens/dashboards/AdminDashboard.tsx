...
export default function AdminDashboard({ navigation }: Props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      subtitle: "View and assign contractor roles",
      icon: "👥",
    },
    {
      title: "Review Task Approvals",
      subtitle: "Approve or reject completed work",
      icon: "✅",
    },
    {
    ...
    },
    {
      ...
      subtitle: "View deadlines and progress",
      icon: "📅",
    },
    {
      title: "Reports & Analytics",
      subtitle: "Generate project performance reports",
      icon: "📊",
    },
  ];
  ...
  const recentActivity = [
    {
      ...
      detail: "Electrical work - Building A",
      time: "2 hours ago",
      status: "success",
    },
    {
      action: "New contractor assigned",
      detail: "John Smith - Plumbing specialist",
      time: "5 hours ago",
      status: "info",
    },
    {
      action: "Task overdue",
      detail: "Painting work - Building C",
      time: "1 day ago",
      status: "warning",
    },
  ];
    ...
    <Container>
      ...
      <Content showsVerticalScrollIndicator={false}>
        ...
        {overdueAlerts.length > 0 && (
          <>
            <SectionTitle style={{ color: colors.error }}>
              ⚠️ Overdue Alerts
            </SectionTitle>
            {overdueAlerts.map((alert, index) => (
              <AlertBanner key={index}>
                ...
                <AlertSubtext>
                  Contractor: {alert.contractor} • {alert.daysOverdue} day(s)
                  overdue
                </AlertSubtext>
              </AlertBanner>
            ))}
